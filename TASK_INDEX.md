...
Current task branch: `fix/formal-training-protocol`

Completed scope: explicit formal validation, reproducibility, evaluation separation, config generation and manifest recording

Next task branch: `exp/full-reproduction` after this branch is reviewed and merged
